...
////  Handee
////
////  Created by Raul Fernando Gutierrez on 2/17/19.
...
//        let imageView = UIImageView(image: #imageLiteral(resourceName: "treeTrimming"))
...
//        let imageView = UIImageView(image: #imageLiteral(resourceName: "grassMowed"))
//        imageView.contentMode = .scaleAspectFill
//        imageView.clipsToBounds = true
//        imageView.layer.borderWidth = 2
//        imageView.layer.borderColor = UIColor.white.cgColor
    ...
    var cardUID: String! {
        didSet {
            ...
            query.document(cardUID).getDocument { (snapshot, err) in
                ...
                self.descriptionLabel.text = "You have requested \(user.name ?? "") services."
            }
