...
//    }
//
//    fileprivate let imageView = UIImageView(image: #imageLiteral(resourceName: "grassDetailed"))
...
//        //        informationLabel.text = "Testizle"
...
//       barsStackView.anchor(top: topAnchor, leading: leadingAnchor, bottom: nil, trailing: trailingAnchor, padding: .init(top: 8, left: 0, bottom: 8, right: 8), size: .init(width: 0, height: 4))
//
...
//
//        //to give your gradient a specific size
...
//        //to layout gradient layer on cardView
//        gradientLayer.frame = self.frame
//    }
//
